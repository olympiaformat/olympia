...
import org.apache.spark.sql.catalyst.parser.extensions.OlympiaParserUtils.withOrigin
import org.apache.spark.sql.catalyst.parser.extensions.OlympiaSqlExtensionsParser.BeginStatementContext
import org.apache.spark.sql.catalyst.parser.extensions.OlympiaSqlExtensionsParser.CommitStatementContext
import org.apache.spark.sql.catalyst.parser.extensions.OlympiaSqlExtensionsParser.RollbackStatementContext
import org.apache.spark.sql.catalyst.parser.extensions.OlympiaSqlExtensionsParser.SingleStatementContext
...
class OlympiaSqlExtensionsAstBuilder(delegate: ParserInterface)
    extends OlympiaSqlExtensionsBaseVisitor[AnyRef] {
