...
/**
 * A Catalog storage starts with a root URI location. Most access to the catalog storage should be
 * to paths under the root. Accessing the full URI should directly use {@link #ops()}.
 */
public interface CatalogStorage extends Closeable, Serializable {
